document.addEventListener('DOMContentLoaded', () => {
  ...
  // type: 'lat' para latitud (N/S), 'lon' para longitud (E/O)
  ...
  if (btnCopy) {
    btnCopy.addEventListener('click', function() {
      ...
      if (coords) {
        ...
        // Coordenadas en DMS
        const latDMS = decimalToDMS(coords.lat, 'lat');
        const lonDMS = decimalToDMS(coords.lon, 'lon');
  ...
  // Forzar recalculo de tamaño del mapa (resuelve pantalla negra)
